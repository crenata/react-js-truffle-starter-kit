 ...
 * in bugs, because programmers usually assume that an overflow raises an error,
...
library SafeMath {
     ...
     *
     * Counterpart to Solidity's `/` operator.
     * Note: this function uses a `revert` opcode (which leaves remaining gas untouched)
     * while Solidity uses an invalid opcode to revert (consuming all remaining gas).
     *
     * Requirements:
